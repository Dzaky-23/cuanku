        ...
        <div className="flex flex-col h-full bg-background/50 backdrop-blur-xl py-6 px-4">
            ...
            <div className="px-2 mb-12">
                <Link href="/" className="flex items-center gap-3 group">
                    <div className="w-10 h-10 bg-primary/10 rounded-xl flex items-center justify-center shadow-sm shadow-primary/20 transition-transform group-hover:scale-105">
                        <WalletCards className="w-5 h-5 text-primary" strokeWidth={1.5} />
                    </div>
